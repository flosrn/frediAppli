    ...
    return {
        ...
        link: function (scope, iElement, iAttrs, ngModelController, transclude) {
            ...
            scope.ui = {
                ...
                searchValue : '',
                searchPlaceholder : iAttrs.searchPlaceholder || 'Recherche',
                subHeaderClass : iAttrs.subHeaderClass || 'bar-stable',
                cancelSearchButton : iAttrs.cancelSearchButton || 'Effacer',
